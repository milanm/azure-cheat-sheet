...
Fetched from: https://azure.microsoft.com/en-gb/products/ (Last update April 11, 2026).
...
* [**Azure AI Speech**](https://azure.microsoft.com/en-us/products/ai-services/ai-speech): Implement speech-to-text, text-to-speech, translation, and speaker recognition in your apps.
...
* [**HDInsight on AKS**](https://azure.microsoft.com/en-gb/products/hdinsight-on-aks/): Next-generation big data analytics on Kubernetes with improved performance and management.
...
* [**Azure Load Testing**](https://azure.microsoft.com/en-gb/services/load-testing/): Optimise app performance with high-scale load testing.
* [**Microsoft Dev Box**](https://azure.microsoft.com/en-gb/products/dev-box/): Cloud-powered developer workstations preconfigured and ready to code.
* [**Azure Deployment Environments**](https://azure.microsoft.com/en-gb/products/deployment-environments/): Quickly spin up app infrastructure environments with project-based templates.
...
* [**Azure Digital Twins**](https://azure.microsoft.com/en-gb/services/digital-twins/): Use IoT spatial intelligence to create models of physical environments.
* [**Azure Remote Rendering**](https://azure.microsoft.com/en-gb/services/remote-rendering/): Render high-quality, interactive 3D content with real-time streaming.
...
* [**Azure AI Services**](https://azure.microsoft.com/en-gb/products/ai-services/): Deploy high-quality AI models as APIs.
...
* [**Azure Orbital**](https://azure.microsoft.com/en-gb/services/orbital/): Satellite ground station and scheduling services for fast downlinking of data.
...
* [**Azure Private 5G Core**](https://azure.microsoft.com/en-gb/services/private-5g-core/): Rapidly deploy and manage private 5G networks at the enterprise edge.
