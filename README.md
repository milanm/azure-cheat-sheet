...
Fetched from: https://azure.microsoft.com/en-gb/products/ (Last update April 2026).
...
* [**Azure AI Foundry**](https://azure.microsoft.com/en-gb/products/ai-foundry/): Build, evaluate, and deploy generative AI solutions and custom copilots.
* [**Azure AI Agent Service**](https://azure.microsoft.com/en-gb/products/ai-services/ai-agent-service/): Build, deploy, and scale AI agents for enterprise automation.
...
* [**Azure Cosmos DB for PostgreSQL**](https://azure.microsoft.com/en-gb/products/cosmos-db/postgresql/): Distributed PostgreSQL powered by Citus for multi-tenant and high-throughput workloads.
* [**SQL Server on Azure Virtual Machines**](https://azure.microsoft.com/en-gb/services/virtual-machines/sql-server/): Migrate SQL Server workloads to the cloud at lower total cost of ownership (TCO).
...
* [**Update Management Centre**](https://azure.microsoft.com/en-gb/services/azure-update-management-center/): Centrally manage updates and compliance at scale.
